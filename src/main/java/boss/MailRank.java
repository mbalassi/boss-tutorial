...
public class MailRank {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSet<Tuple3<Long, Long, Double>> replies = 
				env.readCsvFile("/Users/vkalavri/Downloads/lkml-reply/replies.txt")
				.fieldDelimiter("\t")
				.ignoreComments("%")
				.includeFields("111")
		...
		// Step #6: Run PageRank
		DataSet<Vertex<Long, Double>> ranks = graph.run(new PageRank<Long>(0.85, 63399, 10)).getVertices();
	...
	public static final class SelfRepliesFilter implements FilterFunction<Tuple3<Long, Long, Double>> {
		...
		public boolean filter(Tuple3<Long, Long, Double> tuple) {
			...
			return !(tuple.f0.equals(tuple.f1));
		}
	}
